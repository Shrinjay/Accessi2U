...
export default function GeojsonMap() {
  ...
  console.log('roomGeoJsons', roomGeoJsons);

  return (
    <>
      <div style={{ position: 'relative', width: '100%', height: '100vh' }}>
        <MapContainer center={[43.471689885, -80.54006515274773]} zoom={19} boxZoom={false} maxBoundsViscosity={1.0}>
          ...
          <LayersControl position={'topright'}>
            ...
            <LayersControl.Overlay checked name={'Eng Floors'}>
              <GeoJSON data={floorGeojsons} style={setColor} />
            </LayersControl.Overlay> */}
            <LayersControl.Overlay checked name={'Eng Rooms'}>
              <GeoJSON data={roomGeoJsons?.[0]} style={setColor} />
            </LayersControl.Overlay>
          </LayersControl>
          {/* <GeoJSON data={IMPORTED DATA HERE} pointToLayer={setIcon} /> */}{' '}
          {/*This is for labels, needs points not shapes*/}
        </MapContainer>
      </div>
    </>
  );
